...
class Camera():
    ...
    def update(self):
        if hasattr(self.game,'player') and self.game.player.pid in self.game.entity_manager.entities:
            self.x=self.game.entity_manager.entities[self.game.player.pid].x
            self.y=self.game.entity_manager.entities[self.game.player.pid].y
            self.angle=self.game.entity_manager.entities[self.game.player.pid].angle
